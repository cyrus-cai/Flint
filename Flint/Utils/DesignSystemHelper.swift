...
class LocalizationManager: ObservableObject {
    ...
    private let translations: [String: [String: String]] = [
        ...
        "© 2026 Flint. All rights reserved.": ["zh-Hans": "© 2026 Flint. 保留所有权利。", "zh-Hant": "© 2026 Flint. 保留所有權利。"],
        "Open Flint": ["zh-Hans": "打开 Flint", "zh-Hant": "開啟 Flint"],
        ...
        "Start": ["zh-Hans": "开始", "zh-Hant": "開始"],
        "Change": ["zh-Hans": "更改", "zh-Hant": "更改"],
        "Press Two Keys": ["zh-Hans": "请设置快捷键", "zh-Hant": "請設置快捷鍵"],
        "Set Hotkey": ["zh-Hans": "设快捷键", "zh-Hant": "設快捷鍵"],
        "Save Here": ["zh-Hans": "请设置笔记存放位置", "zh-Hant": "請設置筆記存放位置"],
        "Open Permissions": ["zh-Hans": "最后一步", "zh-Hant": "最後一步"],
        "Enable": ["zh-Hans": "开启", "zh-Hant": "開啟"],
        "Accessibility": ["zh-Hans": "辅助功能", "zh-Hant": "輔助使用"],
        "Notifications": ["zh-Hans": "通知", "zh-Hant": "通知"],
        "Write Now": ["zh-Hans": "开始记录", "zh-Hant": "開始記錄"],
        "Move": ["zh-Hans": "换位置", "zh-Hant": "換位置"],
        "Start Flint": ["zh-Hans": "开始使用 Flint", "zh-Hant": "開始使用 Flint"],
        ...
        "Replay Onboarding": ["zh-Hans": "重播首次引导", "zh-Hant": "重播首次引導"],
        ...
        "Provider": ["zh-Hans": "服务商", "zh-Hant": "服務商"],
        "Model": ["zh-Hans": "模型", "zh-Hant": "模型"],
        ...
        "Flint Feedback": ["zh-Hans": "Flint 反馈", "zh-Hant": "Flint 回饋"],
        ...
        "Quickly access Flint when you need it": ["zh-Hans": "在需要时快速访问 Flint", "zh-Hant": "在需要時快速存取 Flint"],
        "Ready to start your note-taking journey": ["zh-Hans": "准备开始您的笔记之旅", "zh-Hant": "準備開始您的筆記之旅"],
        "Search notes...": ["zh-Hans": "搜索笔记...", "zh-Hant": "搜尋筆記..."],
        "Set your preferred keyboard shortcut to quickly access Flint from anywhere": ["zh-Hans": "设置您喜欢的键盘快捷键，随时随地快速访问 Flint", "zh-Hant": "設定您偏好的鍵盤快捷鍵，隨時隨地快速存取 Flint"],
        ...
        "API Key is required": ["zh-Hans": "API Key 为必填项", "zh-Hant": "API Key 為必填項"],
        "API configuration is invalid": ["zh-Hans": "API 配置无效", "zh-Hant": "API 設定無效"],
        "AI returned an invalid response": ["zh-Hans": "AI 返回了无效响应", "zh-Hant": "AI 回傳了無效回應"],
        "AI request failed (%d)": ["zh-Hans": "AI 请求失败（%d）", "zh-Hant": "AI 請求失敗（%d）"],
        "AI request failed (%d): %@": ["zh-Hans": "AI 请求失败（%d）：%@", "zh-Hant": "AI 請求失敗（%d）：%@"],
