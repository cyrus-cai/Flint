...
struct SettingsListView: View {
    ...
    private func installFlintSkill() {
        // Defer to next runloop to avoid "Publishing changes from within view updates" warning
        DispatchQueue.main.async {
            let notesPath = LocalFileManager.shared.baseDirectory?.path ?? "~/Documents/Flint"
            ...
            let skillContent = """
---
name: flint-manage-notes
description: Guide Claude to operate Flint notes - create, read, update, delete, search, AI operations
---
...
"""
            ...
            let claudeSkillsDir = homeDir.appendingPathComponent(".claude/skills/flint-manage-notes")
            ...
            do {
                ...
                DispatchQueue.main.async {
                    ...
                    notification.informativeText = "Flint Manage Notes skill has been installed to ~/.claude/skills/"
